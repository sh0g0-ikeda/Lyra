...
const SENSITIVE_PATTERNS: Array<[RegExp, string]> = [
  ...
  [
    /(api[_-]?key|x-api-key|client_secret|webhook_secret|stripe_secret_key|stripe_webhook_secret|aws_access_key_id|aws_secret_access_key|aws_session_token|access_key_id|secret_access_key|session_token)\s*[:=]\s*["']?[^"',\s}]+/giu,
    '$1=[redacted]',
  ],
