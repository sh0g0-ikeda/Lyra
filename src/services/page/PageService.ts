...
function buildAutofillCompilerBrief(
  ...
  return [
    ...
    'Work in this order: decide the page beat, split it into panel beats, choose the visible subject or subjects for each panel, then fill the editable fields.',
    'For Japanese manga flow, panel 1 is the upper-right or rightmost top entry; follow the saved layout panel numbers generally right-to-left and downward toward the lower-left.',
    'For regular rows this means right-to-left, then top-to-bottom; saved layout numbering is authoritative for asymmetric layouts.',
