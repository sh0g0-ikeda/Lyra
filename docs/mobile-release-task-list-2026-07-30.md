...
- [ ] PR-F: Story / Characters / PagesのMobile UI
  ...
  - 残り: active generation / export job保護を設計した章・話削除、Backend endpointがない作品削除・並べ替え、scene / Story AI / page skeleton、Characters、Pages、organization workspace UI。PR-F全体は未完了のまま維持する
