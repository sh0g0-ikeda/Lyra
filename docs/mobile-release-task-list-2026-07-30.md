...
- [ ] PR-F: Story / Characters / PagesのMobile UI
  ...
  - 残り: 上記409とdirty draftを扱うMobile章・話削除UI、生成fileを削除可能にするdurable asset cleanup、Backend endpointがない作品削除・並べ替え、scene / Story AI / page skeleton、Characters、Pages、organization workspace UI。PR-F全体は未完了のまま維持する
