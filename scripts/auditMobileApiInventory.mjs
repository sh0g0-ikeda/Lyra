...
const explicitBackendRouteClassifications = new Map([
  ...
  ['GET /organizations/:*\/credits/balance', ['Mobile aggregate replacement', 'Mobile uses the organization billing summary, which contains the authoritative balance.']],
  ['GET /organizations/:*\/billing/plans', ['Mobile aggregate replacement', 'Mobile uses the organization billing summary, which contains the server-owned plan catalog.']],
  ['POST /invitations/:*\/accept', ['Compatibility', 'Legacy invitation acceptance alias; Mobile uses /api/organization-invitations/accept.']],
  ['POST /organizations/:*\/billing/subscription-checkout-session', ['Compatibility', 'Legacy organization checkout alias; Mobile uses the canonical checkout/subscription route.']],
  ['POST /organizations/:*\/billing/credit-pack-checkout-session', ['Compatibility', 'Legacy organization credit alias; Mobile uses the canonical checkout/credits route.']],
  ['POST /organizations/:*\/billing/customer-portal-session', ['Compatibility', 'Legacy organization portal alias; Mobile uses the canonical customer-portal route.']],
