...
const baseTranslations: Record<UiLanguage, Record<BaseTranslationKey, string>> = {
  ...
  en: {
    ...
    emptyScenes: 'No background or time settings yet.',
    ...
    generateReference: 'Create preview image',
    guide: 'Guide',
    ...
    purpose: 'Purpose',
    referenceSet: "Generate the character image",
    reopenPage: 'Reopen',
    refresh: 'Refresh',
    save: 'Save',
    saveScene: 'Save setting',
    scene: 'Setting',
    scenes: 'Background and time settings',
    selectEpisodeFirst: 'Select or create an episode in Story first.',
    selectWorkFirst: 'Select or create a work in Story first.',
    situation: 'Situation',
    sourceS3Key: 'S3 key',
    story: 'Story',
    storyAi: 'Improve your story with AI',
