...
export interface AccountDeletionPreviewRecord {
  ...
  active_personal_stripe_subscription_count: number;
  ...
  personal_asset_count: number;
  active_personal_job_count: number;
}
...
export type AccountDeletionResultRecord =
  ...
  | { status: 'completed'; blockers: never[] };
