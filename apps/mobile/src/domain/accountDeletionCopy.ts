...
interface PersonalSubscriptionDeletionAcknowledgementInput {
  subscriptionCount: number;
  language: 'ja' | 'en';
}

interface StoreBillingDeletionAcknowledgementInput {
  subscriptionCount: number;
  language: 'ja' | 'en';
}

interface PersonalAssetDeletionAcknowledgementInput {
  assetCount: number;
  language: 'ja' | 'en';
}
...
export function personalSubscriptionDeletionAcknowledgement({
  subscriptionCount,
  language
}: PersonalSubscriptionDeletionAcknowledgementInput): string {
  return t(language, 'screen.account.acknowledgeSubscriptionCancellation', {
    subscriptionCount
  });
}

export function storeBillingDeletionAcknowledgement({
  subscriptionCount,
  language
}: StoreBillingDeletionAcknowledgementInput): string {
  return t(language, 'screen.account.acknowledgeMobileSubscriptionCancellation', {
    mobileCount: subscriptionCount
  });
}

export function personalAssetDeletionAcknowledgement({
  assetCount,
  language
}: PersonalAssetDeletionAcknowledgementInput): string {
  return t(language, 'screen.account.acknowledgeAssetDeletion', { assetCount });
}
