...
import { assertSafeWebRuntimeConfig, shouldRequireStrictWebProductionConfig } from './src/lib/webRuntimeGuards';
...
export default defineConfig(({ mode }) => {
  ...
  assertSafeWebRuntimeConfig(env, {
    requireProductionHostedAuth: shouldRequireStrictWebProductionConfig(env),
  });
